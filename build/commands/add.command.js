...
var AddCommand = /** @class */ (function (_super) {
    ...
    AddCommand.prototype.load = function (program) {
        var _this = this;
        program
            .command('add [fullname] [point]')
            .alias('a')
            .description('Add new student and point')
            .action(function (fullname, point) { return __awaiter(_this, void 0, void 0, function () {
            var inputs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.action.handle(inputs)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
