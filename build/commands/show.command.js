...
var ShowCommand = /** @class */ (function (_super) {
    __extends(ShowCommand, _super);
    function ShowCommand() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ShowCommand.prototype.load = function (program) {
        var _this = this;
        program
            .command('show [point]')
            .alias('s')
            ...
            .option('-d, --direction [direction]', 'Sort direction, asc or desc', 'asc')
            .action(function (point, command) { return __awaiter(_this, void 0, void 0, function () {
            var inputs, options;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.action.handle(inputs, options)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
